<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pipeline.aspx.cs" Inherits="CodeClay.PivotGrid" %>
...
<body>
    <form id="frmPipeline" runat="server">
        <asp:SqlDataSource ID="htSQLDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:HealthTreeConnectionString %>" SelectCommand="spPipelineRpt_sel" SelectCommandType="StoredProcedure" OnSelecting="htSQLDataSource_Selecting">
            <SelectParameters>
        ...
        <div>
            <br />
            <dx:ASPxPivotGrid ID="pvgPipeline" runat="server" ClientIDMode="AutoID" DataSourceID="htSQLDataSource" EnableTheming="True" OptionsData-DataProcessingEngine="Optimized" Theme="Aqua" OnHtmlFieldValuePrepared="pvgPipeline_HtmlFieldValuePrepared">
                ...
                <Fields>
                    ...
                    <dx:PivotGridField ID="field11" Area="RowArea" AreaIndex="1" Caption="Supply" GroupIndex="1" InnerGroupIndex="1" Name="field11" SummaryType="Min">
                        <ValueFormat FormatType="Numeric" />
                        <DataBindingSerializable>
                            <dx:DataSourceColumnBinding ColumnName="Inventory_QOH" />
                        </DataBindingSerializable>
                    </dx:PivotGridField>
                </Fields>
